...
# Configuration of the medium GPT-2 model
NUM_HEADS = 16
CONTEXT_LENGHT = 1024
...
# Python dictionary. Configuration of the GPT-2 model
GPT_CONFIG_124M = {
    "vocab_size": 50257,               # Vocabulary size
    "context_length": CONTEXT_LENGHT,  # Context length
    "emb_dim": EMBEDDING_DIMENSION,    # Embedding dimension
    "n_heads": NUM_HEADS,              # Number of attention heads
    "n_layers": N_TRANSFORMER_BLOCKS,  # Number of layers (transformer blocks)
