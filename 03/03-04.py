...
# Third step. Renormalize the attention weights to sum up to 1 again in each row. We achieve this by dividing each element in each row by the sum in each row
...
# Apply the softmax function to the masked results
