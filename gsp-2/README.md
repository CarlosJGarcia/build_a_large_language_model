...
| File | Description | 
|---------|------------------|
| p01_prepare_data.py | Download the OpenWebText dataset from HF, tokenize and save. |
...
| p05_prepare_data_fine.py | Download the Alpaca dataset from HF, filter out the items with extra inputs and save as local .json|
